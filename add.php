...
<body >
			...
			<div class="panel-body" >
				<form method="post" style = "width: 100% ;margin-top:3%;">
					...
					<div class="form-group">
					  ...
					  <input required="true" type="text" class="form-control" id="matkhau" name="chucvu" value="<?=$cv?>" >
					</div>
					<div class="form-group">
					  <label  for="matkhau">Điện Thoại Cơ Quan:</label>
					  
					  <input required="true" type="text" class="form-control" id="matkhau" name="coquan" value="<?=$cq?>" >
					</div>
					<div class="form-group">
					...
					<div class="form-group">
					  ...
					  <input  required="true" type="text" class="form-control" id="matkhau" name="sdt" value="<?=$sdt?>" >
					</div>
					...
					<button onclick="testAlertDialog()" style="width: 100%; font-size:20px" class="btn btn-success">Lưu</button>
				</form>
			</div>
		</div>
	</div>
	<script type="text/javascript">
         ...
         function testAlertDialog()  {
              ...
              alert("Thêm thành công! Quay trở lại trang QUẢN TRỊ!");
         }
